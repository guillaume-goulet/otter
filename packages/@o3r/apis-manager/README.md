...
- Faster page load times: By preconnecting to resources that will be needed in the future, the browser can start resolving DNS, establishing TCP connections, and performing TLS handshakes early, reducing the overall page load time.
...
- Reduced server load: By preconnecting to resources that will be needed in the future, the server load can be reduced, as the server can start serving the resources earlier.
